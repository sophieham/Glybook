...
void bookInformation::on_reserveButton_clicked()
{
    if(connected.getType()){
        ...
        if(answer == QMessageBox::Yes){
            if (book.getFree() && (connected.getLimit() > 0)) {
